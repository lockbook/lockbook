...
lipo -create target/x86_64-apple-darwin/release/libegui_editor.a target/aarch64-apple-darwin/release/libegui_editor.a -output ../SwiftEditor/Libs/libegui_editor.a
cd ../SwiftEditor/Libs
