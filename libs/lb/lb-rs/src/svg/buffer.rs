...
impl Buffer {
    pub fn new(
        content: &str, maybe_core: Option<&Core>, open_file_hmac: Option<DocumentHmac>,
    ) -> Self {
...
fn lb_local_resolver(core: &Core) -> ImageHrefStringResolverFn {
    let core = core.clone();
