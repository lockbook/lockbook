# 👋 **Welcome to Lockbook**   
This is the secure place for your ideas:
- markdown notes 📝
- drawings ✍️
- other files ^^pdfs, images, etc..^^ 📁


## ✅ **Yalla!** 
- [x] ~~Sign up with Lockbook~~ 
- [x] Make your __first__ note 🧠
---
- [ ] Sign in on another device 📱💻
- [ ] Import your existing files 📥
- [x] Share a file/folder with someone you trust 🤝


> [!NOTE] 
> Markdown allows you to write rich formated text, explore the cheat sheet for more info.

### 🗒 Markdown Cheat Sheet<!-- {"fold":true} -->
...
#### Lists
Create a list item by adding `- `, `+ `, or `* ` for a bulleted list, `1. ` for a numbered list, or `- [ ] `, `+ [ ] `, or `* [ ] ` for a task list at the start of the line. The added characters are called the *list marker*. You can also **drag list items to re-order them** whenever your priorities change.
```md
* bulleted list item
- bulleted list item
+ bulleted list item
...
## 🤾 **Get Involved** 
Want to request a feature or encounterd an issue? Bring it up in our [Discord](https://discord.gg/lockbook). We love hearing from you.
Lockbook is simple but powerful. To extend it, check out  Lockbook's docs or read the source code on GitHub.

```rust
// Built with <3 by the lockbook team 🔒
```