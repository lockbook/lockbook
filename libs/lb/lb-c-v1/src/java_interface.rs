...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_init(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_createAccount(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_importAccount(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_exportAccount(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getAccount(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getRoot(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getChildren(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getFileById(
    env: JNIEnv, _: JClass, jid: JString,
) -> jstring {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_renameFile(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_createFile(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_createLink(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_convertToHumanDuration(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getUsage(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getUncompressedUsage(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_deleteFile(
    env: JNIEnv, _: JClass, jid: JString,
) -> jstring {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_readDocument(
    env: JNIEnv, _: JClass, jid: JString,
) -> jstring {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_readDocumentBytes(
    env: JNIEnv, _: JClass, jid: JString,
) -> jbyteArray {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_exportDrawingToDisk(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_writeDocument(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_moveFile(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_syncAll(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_backgroundSync(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_calculateWork(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_exportFile(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_upgradeAccountGooglePlay(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_cancelSubscription(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getSubscriptionInfo(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getLocalChanges(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_listMetadatas(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_startSearch(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_search(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_stopCurrentSearch(env: JNIEnv, _: JClass) -> jstring {
    send_search_request(env, SearchRequest::StopCurrentSearch)
}

#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_endSearch(env: JNIEnv, _: JClass) -> jstring {
    send_search_request(env, SearchRequest::EndSearch)
}

#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_shareFile(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getPendingShares(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_deletePendingShare(
    env: JNIEnv, _: JClass, jid: JString,
) -> jstring {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getDrawing(
    env: JNIEnv, _: JClass, jid: JString,
) -> jstring {
    let id = match deserialize_id(&env, jid) {
        Ok(ok) => ok,
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_saveDrawing(
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_suggestedDocs(env: JNIEnv, _: JClass) -> jstring {
    string_to_jstring(
        &env,
        match static_state::get() {
...
#[no_mangle]
pub extern "system" fn Java_app_lb_CoreKt_getAllErrorVariants(env: JNIEnv, _: JClass) -> jstring {
