...
impl<'ast> Editor {
    pub fn indent(&self, node: &'ast AstNode<'ast>) -> f32 {
        ...
        match value {
            ...
            // container_block
            NodeValue::Alert(_) => self.visuals.indent,
            NodeValue::BlockQuote => self.visuals.indent,
            ...
            NodeValue::FootnoteDefinition(_) => self.visuals.indent,
            NodeValue::Item(_) => self.visuals.indent,
            ...
            NodeValue::TaskItem(_) => self.visuals.indent,
    ...
    pub fn show_block_children(
        ...
        for child in &children {
            ...
            let pre_spacing_above_viewport =
                2. * self.visuals.margin > tolerance + top_left.y + pre_spacing;
            let pre_spacing_below_viewport =
                2. * self.visuals.margin + self.height + tolerance < top_left.y;
            ...
            let block_above_viewport =
                2. * self.visuals.margin > tolerance + top_left.y + child_height;
            ...
            let post_spacing_above_viewport =
                2. * self.visuals.margin > tolerance + top_left.y + post_spacing;
