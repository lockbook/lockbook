...
pub trait UITextInputTokenizer {
    ...
    fn is_position_at_boundary(
        &self, text_position: Grapheme, at_boundary: Bound, in_backward_direction: bool,
    ) -> bool;
    ...
    fn is_position_within_text_unit(
        &self, text_position: Grapheme, within_text_unit: Bound, in_backward_direction: bool,
    ) -> bool;

    /// Returns the next text position at a boundary of a text unit of the given granularity in a given direction.
    fn position_from(
        &self, text_position: Grapheme, to_boundary: Bound, in_backward_direction: bool,
    ) -> Option<Grapheme>;
    ...
    fn range_enclosing_position(
        &self, text_position: Grapheme, with_granularity: Bound, in_backward_direction: bool,
...
impl UITextInputTokenizer for MdEdit {
    fn is_position_at_boundary(
        ...
        let ranges = match at_boundary {
            ...
            Bound::Doc => {
                return text_position == Grapheme(0)
