...
fn write_document_read_share() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::InsufficientPermission);
}
...
fn delete_nonexistent_share() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::ShareNonexistent);
}
...
fn share_file_duplicate() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::ShareAlreadyExists);
}
...
fn share_folder_with_link_inside() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::LinkInSharedFolder);
}
...
fn create_link_at_path_target_is_owned() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::LinkTargetIsOwned);
}
...
fn create_link_at_path_target_nonexistent() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::LinkTargetNonexistent);
}
...
fn create_link_at_path_link_duplicate() {
    ...
    assert_matches!(result.unwrap_err().kind, LbErrorKind::MultipleLinksToSameFile);
}
