...
fn fuzzer_stuck_test_2() {
    ...
    let b = lockbook_core::create_file_at_path(&db2, &test_utils::path(&root, "/a/b/")).unwrap();
...
fn fuzzer_stuck_test_3() {
    ...
    let _b = lockbook_core::create_file_at_path(&db1, &test_utils::path(&root, "/a/b.md")).unwrap();
    let c = lockbook_core::create_file_at_path(&db1, &test_utils::path(&root, "/a/c")).unwrap();
    lockbook_core::rename_file(&db1, c.id, "c2").unwrap();

    let _d = lockbook_core::create_file_at_path(&db1, &test_utils::path(&root, "/a/d")).unwrap();
...
fn fuzzer_stuck_test_4() {
    ...
    lockbook_core::move_file(&db2, b.id, root.id).unwrap();
    lockbook_core::rename_file(&db2, b.id, "b2").unwrap();
    let c = lockbook_core::create_file_at_path(&db2, &test_utils::path(&root, "/c.md")).unwrap();
...
fn fuzzer_get_updates_required_test() {
    ...
    let document =
        lockbook_core::create_file_at_path(&db1, &test_utils::path(&root, "/document")).unwrap();
