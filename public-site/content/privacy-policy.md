...
We can see the shape of your file tree, and we know when a file is updated. We can tell which version of the code you’re running and what client you're using (for example: "iOS").
