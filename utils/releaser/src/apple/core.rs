...
fn build_libs() {
    ...
    Command::new("lipo")
        .args([
            "-create",
            "-output",
            "target/universal-macos/liblb_c_v1.a",
            "target/x86_64-apple-darwin/release/liblb_c_v1.a",
            "target/aarch64-apple-darwin/release/liblb_c_v1.a",
        ])
        .assert_success();
}
