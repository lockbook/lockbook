...
const KEYS: [Key; 89] = [
    ...
    Key { sc: 27, egui: None, text: Some("]"), s_text: Some("}") },
    Key { sc: 28, egui: Some(egui::Key::Enter), text: None, s_text: None },
    Key { sc: 39, egui: None, text: Some(";"), s_text: Some(":") },
    ...
    Key { sc: 71, egui: None, text: Some("7"), s_text: None },
    Key { sc: 72, egui: None, text: Some("8"), s_text: None },
    Key { sc: 73, egui: None, text: Some("9"), s_text: None },
    Key { sc: 74, egui: None, text: Some("-"), s_text: None },
    Key { sc: 75, egui: None, text: Some("4"), s_text: None },
    Key { sc: 76, egui: None, text: Some("5"), s_text: None },
    Key { sc: 77, egui: None, text: Some("6"), s_text: None },
    Key { sc: 78, egui: None, text: Some("+"), s_text: None },
    Key { sc: 79, egui: None, text: Some("1"), s_text: None },
    Key { sc: 80, egui: None, text: Some("2"), s_text: None },
    Key { sc: 81, egui: None, text: Some("3"), s_text: None },
    Key { sc: 82, egui: None, text: Some("0"), s_text: None },
    Key { sc: 83, egui: None, text: Some("."), s_text: None },
