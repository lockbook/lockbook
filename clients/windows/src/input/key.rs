...
const KEYS: [Key; 74] = [
    ...
    Key { vk: VK_OEM_2, egui: None, text: Some("/"), s_text: Some("?") },
    Key { vk: VK_OEM_3, egui: None, text: Some("`"), s_text: Some("~") },
    Key { vk: VK_OEM_4, egui: None, text: Some("["), s_text: Some("{") },
    Key { vk: VK_OEM_5, egui: None, text: Some("\\"), s_text: Some("|") },
    Key { vk: VK_OEM_6, egui: None, text: Some("]"), s_text: Some("}") },
