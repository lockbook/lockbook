...
pub use chrome::{
    ...
    paint_plate_stroke, phosphor, phosphor_titleband_font_id, phosphor_ui_font_id, plate_content,
    shortcut_cmd_i, shortcut_cmd_n, shortcut_enter, shortcut_esc, shortcut_return,
};
