...
class FileTreeViewModel: ObservableObject {
    ...
    init(filesModel: FilesViewModel, workspaceInput _: WorkspaceInputState, workspaceOutput: WorkspaceOutputState) {
...
extension FileTreeViewModel {
    static var preview: FileTreeViewModel {
        FileTreeViewModel(filesModel: .preview, workspaceInput: .preview, workspaceOutput: .preview)
    }
}
