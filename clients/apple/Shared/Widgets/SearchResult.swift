...
struct SearchPathResultView: View {
    ...
    init(name: String, path: String, matchedIndices: [UInt]) {
        ...
        _nameModified = State(initialValue: nameAndPath.formattedName)
        _pathModified = State(initialValue: nameAndPath.formattedPath)
    }
...
struct SearchContentResultView: View {
    ...
    init(name: String, path: String, contentMatches: [ContentMatch]) {
        ...
        _formattedPath = State(initialValue: pathAndParagraphs.formattedPath)
        _formattedParagraphs = State(initialValue: pathAndParagraphs.formattedParagraphs)
    }
...
struct PathSearchResultView: View {
    ...
    @State var pathModified: Text = .init("")
    @State var nameModified: Text = .init("")
