...
class WriteToDocumentTest {
    ...
    fun writeToDocumentNoAccount() {
        ...
        coreModel.insertFile(document).component1()!!
        Runtime.getRuntime().exec("rm -rf $path/*")
        val writeToDocumentError = CoreModel.writeContentToDocument(Config(path), "", document.id).component2()!!
        require(writeToDocumentError is WriteToDocumentError.NoAccount)
    }
    ...
    fun writeToDocumentFileDoesNotExist() {
        ...
        coreModel.setParentToRoot().component1()!!
        val writeToDocumentError = CoreModel.writeContentToDocument(Config(path), "", generateAlphaString()).component2()!!
