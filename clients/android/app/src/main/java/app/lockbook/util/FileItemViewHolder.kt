...
class SearchedDocumentNameViewHolder(itemView: View) : ViewHolder(itemView) {
    val fileItemHolder: ConstraintLayout = itemView.findViewById(R.id.searched_document_item_holder)
...
class SearchedDocumentContentViewHolder(itemView: View) : ViewHolder(itemView) {
    val fileItemHolder: ConstraintLayout = itemView.findViewById(R.id.searched_document_content_item_holder)
